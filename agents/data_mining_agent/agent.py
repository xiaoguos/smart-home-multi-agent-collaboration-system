...
class DataMiningAgent:
    ...
    DEFAULT_SYSTEM_PROMPT = (
        ...
        ''
        '用户ID提取规则：'
        '消息中可能包含用户ID标记，必须识别并传给工具：'
        '  - 格式1：「(用户ID: 1000000001)」→ system_user_id=1000000001'
        '  - 格式2：「[SYSTEM_USER_ID:1000000001]」→ system_user_id=1000000001'
        '  - 若消息中无用户ID标记，使用默认值 1000000001'
        ''
        '工具使用指南：'
